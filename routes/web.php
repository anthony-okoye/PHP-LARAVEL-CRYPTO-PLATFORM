...
Route::post('contact-us', ['as' => 'contactp_us', 'uses' => 'HomeController@contactUsPost']);
...
Route::post('checkout/nowpayment', ['as' => 'nowpayment_receive', 'uses' => 'CampaignsController@NowPaymentReceive']);
...
Route::group(['prefix'=>'dashboard', 'middleware' => 'auth'], function() {
    ...
    Route::group(['middleware' => 'admin'], function() {
        ...
        Route::group(['prefix'=>'settings'], function(){
            ...
            Route::post('other', ['as'=>'otherp_settings', 'uses' => 'SettingsController@OtherSettingsPost']);
        });
        ...
        Route::group(['prefix'=>'users'], function(){
            ...
            Route::get('profile/change-avatar/{id}', ['as'=>'changeid_avatar', 'uses' => 'UserController@changeAvatar']);
